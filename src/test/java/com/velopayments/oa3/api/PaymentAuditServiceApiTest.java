...
public class PaymentAuditServiceApiTest {
    ...
    @Deprecated
    @DisplayName("Test Get Payouts for Payors V3")
    @Test
    ...
    @Deprecated
    @DisplayName("Test Get Payments for Payout V3")
    @Test
    ...
    @Deprecated
    @DisplayName("Test Get List of Payments V3")
    @Test
    ...
    @Deprecated
    @DisplayName("Test Get Payment V3")
    @Test
    ...
    @DisplayName("Test Get Payouts for Payor V4")
    @Test
    ...
    @DisplayName("Test Get Payouts for Payor V4 - REJECTED")
    @Test
    ...
    @DisplayName("Test Get Payouts for Payor V4 - QUOTED")
    @Test
    ...
    @DisplayName("Test Get Payments for Payout V4")
    @Test
    ...
    @DisplayName("Test Get List of Payments V4")
    @Test
    ...
    @DisplayName("Test Get Payment V4")
    @Test
    ...
    @DisplayName("Test Export Transactions V3")
    @Test
